...
public class HomePage {
    ...
    By errorMessage = By.xpath(".//div[@id='center_column']/p[@class='alert alert-warning']");
    ...
    public void searchUnexistingItem(String itemName){
        searchItem(itemName);
        WebElement errorEl = wait.until(ExpectedConditions.presenceOfElementLocated(errorMessage));
    }
