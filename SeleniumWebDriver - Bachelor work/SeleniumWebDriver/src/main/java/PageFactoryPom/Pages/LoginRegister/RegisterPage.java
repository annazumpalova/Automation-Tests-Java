...
public class RegisterPage {
    ...
    By email = By.xpath(".//div[@class='required form-group']/input[@id='email']");
    ...
    public void fillAllInformation(String customerFirstNameKInput, String customerLastNameInput, String passInput,
        ...
        try{
            Assert.assertEquals(driver.findElement(email).getAttribute("value"), "azumpalova05@abv.bg");
        ...
        actions.click(genderEl).perform();
        actions.sendKeys(customerFirstNameEl, customerFirstNameKInput).perform();
        actions.sendKeys(customerLastNameEl, customerLastNameInput).perform();
        actions.sendKeys(passEl, passInput).perform();
        actions.click(birthdayElDay).perform();
        actions.click(birthdayElMonth).perform();
        actions.click(birthdayElYear).perform();
        actions.sendKeys(firstNameEl, firstNameInput).perform();
        actions.sendKeys(lastNameEl, lastNameInput).perform();
        actions.sendKeys(companyNameEl, companyInput).perform();
        actions.sendKeys(address1El, address1Input).perform();
        actions.sendKeys(address2El, adress2Input).perform();
        actions.sendKeys(cityEl, cityInput).perform();
        actions.click(idStateEl).perform();
        actions.sendKeys(postcodeEl, postcodeInput).perform();
        actions.sendKeys(textareaEl, "My automation tests are running!").perform();
        actions.sendKeys(phoneEl, phoneInput).perform();
        actions.sendKeys(phoneMobileEl, mobilePhoneInput).perform();
        actions.sendKeys(aliasEl, aliasInput).perform();
        actions.build();
