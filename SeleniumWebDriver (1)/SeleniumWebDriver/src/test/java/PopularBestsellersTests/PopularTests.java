...
public class PopularTests extends MainSetUp{
    ...
    public PopularTests(String item, String price, String quant, String size, String col) {
    ...
    public void popularSectionQuickView() throws IOException, InterruptedException {
        ...
        QuickViewPage quickViewPage = popularSection.addToCardFromPopularSection(itemDetails);
        Thread.sleep(5000);
    ...
    @Test
    public void popularSectionMore() throws InterruptedException {
        HomePage homePage = new HomePage(driver, this.getMainURL());
        homePage.loadPage();
    ...
    @Test
    public void popularAddToCard() throws InterruptedException {
        HomePage homePage = new HomePage(driver, this.getMainURL());
        homePage.loadPage();
